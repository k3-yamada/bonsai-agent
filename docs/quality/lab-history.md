...
| 265 G-MCT2 (in-progress) | max_context_tokens reduction (smoke=1 で 14000→6000 自動) | **IN-FLIGHT** (2026-05-30 09:48 start) | compaction.budget emit total=**6000** 確証 (SMOKE_DEFAULT_MAX_CTX 一致) + budget allocation 1800/1800/900/1500 = 30/30/15/25 of 6000 完璧反映 | 項目 264 root cause (prune 不発火 = total=14000 で threshold 4500/9000/12600 未達) の解消、Phase 4 ACCEPT 条件 = `[prev:` marker ≥ 5、最終判定は smoke 完了後 (~80 min wall) |
