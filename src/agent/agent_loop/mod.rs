...
use advisor_inject::{inject_planning_step, inject_replan_on_stall, inject_verification_step};
use support::{
    build_answer, check_invariants, compute_output_hash, record_abort, record_success,
};
...
mod tests {
    ...
    use super::advisor_inject::{
        AdvisorResolution, log_advisor_call, resolve_advisor_prompt,
    };
